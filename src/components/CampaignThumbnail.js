  ...
  if (campaign) {
    ...
    return (
      <div>
        <Card>
          <Card.Content>
            <Card.Header>{favCampaign.title}</Card.Header>
            <Image src={favCampaign.photo_url} />
            <Card.Meta>
              <span className="date">
                <Icon name="location arrow" />
                {favCampaign.location}
              </span>
            </Card.Meta>
            <Card.Description>
              Organization Name: {favCampaign.org_name}
            </Card.Description>
          </Card.Content>
          <Card.Content extra>
            <a href="/home">
              <Icon name="paw" />
              Urgency Level: {favCampaign.urgency_level}
            </a>
          </Card.Content>
          <Button onClick={() => deleteFavCampaign(id, favCampaign.id)}>
            Delete
          </Button>
        </Card>
      </div>
